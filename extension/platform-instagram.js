(() => {
  ...
  function extract(container, expectedHandle, preferredSourceUrl = "") {
    ...
    const isDialog = Boolean(container.closest?.('div[role="dialog"], [role="presentation"]') || document.querySelector('div[role="dialog"]'));
    const isOwn = isDialog || isProfilePage || !normalizedAuthor || (currentAccount && normalizedAuthor === currentAccount) || (expected && normalizedAuthor === expected);
